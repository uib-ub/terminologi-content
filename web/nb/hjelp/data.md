...
Termportalen inneholder hovedsakelig åpne data, men noen av termbasene er underlagt restriksjoner for bruk. Du finner informasjon om lisensen som gjelder for hver enkelt termbase, på informasjonssiden til den aktuelle termbasen.

::HeadingTp{level="h3"}
API
::

Vi arbeider med å utvikle et eget API for deling av åpne data fra Termportalen.
...
Geomagnetisk polkalott (2023) i Romfysikk (Termportalen). Tilgjengelig fra: https://www.termportalen.no/tb/ROMFYS/Geomagnetisk_polkalott (Hentet: 11. juli 2025).
